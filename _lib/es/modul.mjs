...
*/
import { a as addinsertCreateElement, g as getActualWidthOfChars, i as insertCreateAfter } from '../../index-a7804956.js';
import { i as isMobile } from '../../index-d9c15d96.js';
...
function dynamicTitleUnderline() {
    ...
    function dynamicUnderline() {
        ...
        for (let index = 0; index < AllDocumentTitleElement.length; index++) {
            ...
            var font = Style.font;
            var width = getActualWidthOfChars(txt, { size: font }) + 13;
            if (width < 58) {
                width = 58;
            } //动态下划线最小宽度
            if (width > maxWidth) {
