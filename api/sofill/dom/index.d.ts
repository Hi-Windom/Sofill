export { insertCreateAfter, addinsertCreateElement, MoveDOM, MoveChildren, CopyDOM, diguiTooONE, getActualWidthOfChars, };
declare function getActualWidthOfChars(text: any, options: {
    size: string | number;
    family?: string;
}): number;
/**
 ...
 */
declare function addinsertCreateElement(fatherElement: Element, addElementTxt: string, setId?: string): HTMLElement;
/**
